...
namespace csharp_functions
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] arrProva = { 1, 2, 3, 4, 5, };

            
            var anInstanceofMyClass = new Program();

            //anInstanceofMyClass.StampaArray(arrProva);

            //Console.WriteLine(
            //anInstanceofMyClass.Quadrato(7)
            //);

            anInstanceofMyClass.StampaArray(anInstanceofMyClass.ElevaArrayAlQuadrato(arrProva));
